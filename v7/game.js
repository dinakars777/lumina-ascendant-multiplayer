...
function updateHUD() {
    ...
    if (ui.objectiveText) {
        if (state.paused) {
            ...
            ui.objectiveText.textContent = `${modePrefix}Ignite beacons (${state.beaconsLit}/${CONFIG.BEACON_COUNT}). Fire ${firePct}% | Threat ${threatPct}%${nemesisText}${orbText}${driveText}.`;
